 ...
 * <p>
 * The views used as tabs can be customized by calling {@link #setCustomTabView(int, int, int, int)},
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int imageViewId,int textViewId, int underlineId) {
        mTabViewLayoutId = layoutResId;
        mTabViewImageVId = imageViewId;
        mTabViewTextViewId = textViewId;
        mUnderLineId = underlineId;
    }
    ...
    private void populateTabStrip() {
        final MyFragPagerAdapter adapter = (MyFragPagerAdapter)mViewPager.getAdapter();
        final View.OnClickListener tabClickListener = new TabClickListener();

        for (int i = 0; i < adapter.getCount(); i++) {
            View tabView = null;
            ImageView tableImg = null;
            TextView tabTitleView = null;
            ImageView tableUnderln = null;
            if (mTabViewLayoutId != 0) {
                ...
                tableImg = (ImageView) tabView.findViewById(mTabViewImageVId);
                tabTitleView = (TextView) tabView.findViewById(mTabViewTextViewId);
                tabTitleView.setWidth(screenX);
                tableUnderln = (ImageView) tabView.findViewById(mUnderLineId);
            ...
            if(tableImg != null)
                tableImg.setImageResource(adapter.getImageId(i));
